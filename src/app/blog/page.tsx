...
const POSTS = [
  { title: "How the AI recommendation engine actually works", excerpt: "A behind-the-scenes look at how Shopping AI turns a budget and a wish list into a ranked shortlist.", date: "Jul 2026", readTime: "6 min read" },
...
export const metadata = { title: "Blog | AI Shopping Intelligence Platform" };
        ...
        <section className="py-24">
          <div className="mx-auto max-w-3xl px-4 text-center sm:px-8">
            ...
            <p className="mx-auto mt-6 max-w-xl text-lg leading-8 text-slate-600">
              Product updates, buying guides, and the occasional deep dive into how Shopping AI is built.
            </p>
          </div>
        </section>
