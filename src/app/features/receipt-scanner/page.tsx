...
export const metadata = { title: "Receipt Scanner | Pricewise" };
...
export default function ReceiptScannerFeaturePage() {
  return (
    <FeaturePage
      ...
      description="Photograph a paper receipt and Pricewise extracts the items, prices, and warranty terms automatically - so your spending is tracked and you get a reminder before a claim window closes."
      ...
      guide={[
        ...
        { title: "Get reminded before it expires", body: "Pricewise tracks the warranty window and alerts you before a claim deadline passes." }
      ]}
      faqs={[
        ...
        { q: "What happens as a warranty gets close to expiring?", a: "Pricewise sends a reminder ahead of the claim window closing, based on the warranty terms extracted from the receipt." }
      ]}
    />
  );
}
